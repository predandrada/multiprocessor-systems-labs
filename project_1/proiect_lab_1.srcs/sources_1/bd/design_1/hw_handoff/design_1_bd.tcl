...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net core_logic_0_trdy [get_bd_pins core_logic_0/trdy] [get_bd_pins graphic_controller_0/trdy]
  connect_bd_net -net graphic_controller_0_ad [get_bd_pins core_logic_0/ad] [get_bd_pins graphic_controller_0/ad]
  connect_bd_net -net graphic_controller_0_c_be [get_bd_pins core_logic_0/c_be] [get_bd_pins graphic_controller_0/c_be]
  ...
  connect_bd_net -net graphic_controller_0_irdy [get_bd_pins core_logic_0/irdy] [get_bd_pins graphic_controller_0/irdy]
