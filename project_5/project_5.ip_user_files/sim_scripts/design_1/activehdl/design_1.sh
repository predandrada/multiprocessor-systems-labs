...
#
# Generated by Vivado on Sun Jan 17 19:23:54 +0200 2021
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="B:/shoebox/uni/year 4/first/smp/labs/project_5/project_5.cache/compile_simlib/activehdl"
  fi
